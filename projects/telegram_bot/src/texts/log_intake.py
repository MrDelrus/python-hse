ASK_WATER = "How much have your drunk since the last update? Please, enter the value (ml)."
ASK_WATER_NO_ARGS = (
    "Please enter '/log_water <water amount, ml> instead."
    "No jokes with the value!"
)
...
FOOD_NOT_FOUND = "Sorry! We don't know such product... Try again!"
CLIENT_ERROR = "Sorry! We did not get the response from the external service, try again later."
...
ASK_WORKOUT_NO_ARGS = "Please enter '/log_workout <activity type> <activity time> instead."
